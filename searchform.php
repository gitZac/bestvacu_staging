<form role="search" method="get" class="c-search-form" action="<?php echo esc_url( home_url( '/' ) ) ?>">
    <label class="c-search-form__label">
        ...
        <input type="search" class="c-search-form__field" placeholder="<?php echo esc_attr_x( 'Find Vacuums &hellip;', 'placeholder', '_themename' ) ?>" value="<?php echo esc_attr(get_search_query()) ?>" name="s" />
    </label>
